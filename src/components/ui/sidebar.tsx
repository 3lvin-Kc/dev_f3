  ...
  (
      ...
      return (
        <>
          ...
          <div
            ref={ref}
            className={cn(
              "fixed inset-y-0 z-50 hidden w-[--sidebar-width-mobile] flex-col border-r bg-sidebar text-sidebar-foreground transition-transform duration-200 ease-in-out md:flex",
    ...
    return (
      <div
        ...
        {...props}
      >
        <div className={cn("flex h-full w-full flex-col bg-sidebar border-r")}>
          {children}
        </div>
      </div>
    )
